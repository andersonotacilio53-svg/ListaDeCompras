...
namespace ListaDeCompras
{
    public partial class Form1 : Form
    {
        ...
        {
            // Vrificar se txbProduto está vazio:
            if (txbProduto.Text.Length == 0)
            {
                MessageBox.Show("O nome de produto não pode estar vazio!",
            ...
            {
                MessageBox.Show("O nome de produto precisa ter no mínimo duas letras!",
                    "Erro!", MessageBoxButtons.OK, MessageBoxIcon.Error);
                //Mudar a cor do fundo e a cor da letra:
                txbProduto.BackColor = Color.Red;
                txbProduto.ForeColor = Color.White;
